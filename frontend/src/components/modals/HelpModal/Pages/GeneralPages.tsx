        ...
        <>
            <div>
                ...
                <ul>
                    ...
                    <li><strong>Auto-fix Upstream:</strong> Automatically fix upstream edges when editing an edge.</li>
    ...
    return (
        <div>
            ...
            <p className="d-inline-flex flex-wrap align-items-center justify-content-center mb-2 mt-0">
                ...
                <a href="https://www.reddit.com/user/Dorito009/" className="clickable-link default-purple fw-semibold" target="_blank" rel="noopener noreferrer">&nbsp;u/Dorito009&nbsp;</a>
                and 
                <a href="https://www.reddit.com/user/GamingIkno/" className="clickable-link default-purple fw-semibold" target="_blank" rel="noopener noreferrer">&nbsp;u/GamingIkno</a>
                .
            </p>
        </div>
    );
